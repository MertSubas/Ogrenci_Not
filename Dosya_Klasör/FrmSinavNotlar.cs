...
namespace Dosya_Klasör
{
    public partial class FrmSinavNotlar : Form
    {
        ...
        {
            dataGridView1.DataSource = ds.NotListe(int.Parse(textBox1.Text));
        }
        int notid;
        ...
        {
            ds.NotGuncelle(byte.Parse(comboBox1.SelectedValue.ToString()), int.Parse(textBox1.Text), byte.Parse(txtsinav1.Text), byte.Parse(txtsinav2.Text), byte.Parse(txtsinav3.Text), byte.Parse(txtproje.Text), decimal.Parse(txtort.Text), bool.Parse(txtdurum.Text), notid);
